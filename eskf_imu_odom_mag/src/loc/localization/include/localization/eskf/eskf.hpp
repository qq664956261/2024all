...
#include "localization/common/gnss.h"
#include "localization/common/imu.h"
#include "localization/common/math_utils.h"
#include "localization/common/nav_state.h"
...
bool ESKF<S>::ObserveWheelSpeed(const Odom& odom) {
    ...
    //std::cout<<"odom.timestamp_:"<<std::to_string(odom.timestamp_)<<std::endl;
    ...
    double velo_l = odom.left_pulse_;
    double velo_r = odom.right_pulse_;
    double average_vel = 0.5 * (velo_l + velo_r);

    VecT vel_odom(average_vel, 0.0, 0.0);
    VecT vel_world = R_ * vel_odom;
    
    VecT diff = vel_world - v_;
