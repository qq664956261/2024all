...
NodeOptions CreateNodeOptions(
  ...
  //用法示例
  //auto map_builder_config = lua_dict->GetDictionary("map_builder");
  //bool use_2d = map_builder_config->GetBool("use_trajectory_builder_2d");
  //int threads = map_builder_config->GetInt("num_background_threads");
 ...
 */
//目的：从指定的 Lua 配置文件中加载参数，并生成 NodeOptions 和 TrajectoryOptions 对象。
//返回值：
//返回一个 std::tuple<NodeOptions, TrajectoryOptions>：
//NodeOptions：节点相关的配置。
//TrajectoryOptions：轨迹相关的配置。
