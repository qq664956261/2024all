    ...
    namespace mapping
    {
        namespace scan_matching
        {
            ...
            public:
                ...
                double compute_curpoints_score(const transform::Rigid2d &initial_pose_estimate,
                             const hjSlam_2d::PointCloud &point_cloud, const Grid2D &grid,
                             transform::Rigid2d *pose_estimate) const;

                double compute_occupied_score(const hjSlam_2d::PointCloud &point_cloud, const Grid2D &grid);
