  ...
  namespace mapping
  {
    namespace scan_matching
    {
          ...
          : resolution(resolution)
      {
        ...
        for (const hjSlam_2d::RangefinderPoint &point : point_cloud)
        {
      ...
      {
        std::vector<hjSlam_2d::PointCloud> rotated_scans;
        ...
        {
          rotated_scans.push_back(hjSlam_2d::TransformPointCloud(
          ...
          const Eigen::Translation2f &initial_translation)
      {
        ...
        for (const hjSlam_2d::PointCloud &scan : scans)
        {
          discrete_scans.emplace_back();
          discrete_scans.back().reserve(scan.size());
          for (const hjSlam_2d::RangefinderPoint &point : scan)
          {
