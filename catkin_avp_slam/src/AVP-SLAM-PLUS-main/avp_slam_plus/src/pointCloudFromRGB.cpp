   ...
   ros::Rate rate(100);
    while (ros::ok()) {
        ...
        if(!camera0ImageBuf.empty() && !camera1ImageBuf.empty() && !camera2ImageBuf.empty() && !camera3ImageBuf.empty() && !camera4ImageBuf.empty() && !camera5ImageBuf.empty()){
            ...
            timeCamera1Image = timeCamera0Image;
            timeCamera2Image = timeCamera0Image;
            timeCamera3Image = timeCamera0Image;
            timeCamera4Image = timeCamera0Image;
            timeCamera5Image = timeCamera0Image;
