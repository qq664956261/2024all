...
struct MD5Sum< ::hj_interface::AppMsg_<ContainerAllocator> >
{
  ...
  {
    return "488a983cc55b1d58c4d05999345840f0";
  }

  static const char* value(const ::hj_interface::AppMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x488a983cc55b1d58ULL;
  static const uint64_t static_value2 = 0xc4d05999345840f0ULL;
};
