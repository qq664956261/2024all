...
class ScanContext:
    ...
    sector_res = np.array([60]) # 60
    ring_res = np.array([20]) # 20
    max_length = 10
    
     
    def __init__(self, point_cloud):
        self.point_cloud = np.array(point_cloud.points)
    ...
    def genSCs(self):
        print("The number of original points: " + str(self.point_cloud.shape) ) 
